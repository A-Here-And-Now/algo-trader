...
import (
	...
	helper "github.com/A-Here-And-Now/algo-trader/orchestration_api/entities/signaler/helpers"
...
/*******************************************/
type TrendFollowingStrategy struct{ *positionHolder }

func (s *TrendFollowingStrategy) CalculateSignal(symbol string,
	priceStore PriceActionStore) models.Signal {
