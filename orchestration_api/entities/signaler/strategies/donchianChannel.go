...
type DonchianChannelStrategy struct{ *helper.PositionHolder }

func (s *DonchianChannelStrategy) CalculateSignal(symbol string, priceStore helper.IPriceActionStore) models.Signal {
